...
class DateTimeUtilTest extends TestCase
{
    ...
    public function testGetModifiedDate()
    {
        ...
        $expectedDate = new \DateTime("+2months");
        $result = $this->dateTimeUtil->getModifiedDate($firstDate, "+2months");
        ...
        $firstDate = new \DateTime();
        $expectedDate = new \DateTime("+2years");
        $result = $this->dateTimeUtil->getModifiedDate($firstDate, "+2years");
        $this->assertEquals($expectedDate, $result);
        $this->assertNotEquals(spl_object_hash($firstDate), spl_object_hash($result));
        ...
        $firstDate = new \DateTime();
        $expectedDate = new \DateTime("+2hours");
        $result = $this->dateTimeUtil->getModifiedDate($firstDate, "+2hours");
        $this->assertEquals($expectedDate, $result);
        $this->assertNotEquals(spl_object_hash($firstDate), spl_object_hash($result));
        ...
        $firstDate = new \DateTime();
        $expectedDate = new \DateTime("+2minutes");
        $result = $this->dateTimeUtil->getModifiedDate($firstDate, "+2minutes");
        $this->assertEquals($expectedDate, $result);
        $this->assertNotEquals(spl_object_hash($firstDate), spl_object_hash($result));
        ...
        $firstDate = new \DateTime();
        $expectedDate = new \DateTime("+2seconds");
        $result = $this->dateTimeUtil->getModifiedDate($firstDate, "+2seconds");
        $this->assertEquals($expectedDate, $result);
        $this->assertNotEquals(spl_object_hash($firstDate), spl_object_hash($result));
